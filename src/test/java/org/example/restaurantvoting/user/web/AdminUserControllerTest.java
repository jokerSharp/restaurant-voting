...
import static org.example.restaurantvoting.user.web.AdminUserController.REST_URL;
import static org.example.restaurantvoting.user.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin, guest, justAdmin, user));
    }
