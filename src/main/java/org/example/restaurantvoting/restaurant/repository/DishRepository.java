...
public interface DishRepository extends BaseRepository<Dish> {
    ...
    default Dish getBelonged(int restaurantId, int id) {
        return findOneByRestaurantId(restaurantId, id).orElseThrow(
                () -> new IllegalRequestDataException("Dish id=" + id + " is not exist or doesn't belong to restaurant id=" + restaurantId));
    }
}
